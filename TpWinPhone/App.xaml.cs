...
namespace TpWinPhone
{
    ...
    public sealed partial class App : Application
    {
        ...
        //DataBase Name
        public static string DB_PATH = Path.Combine(Path.Combine(ApplicationData.Current.LocalFolder.Path, "Records.sqlite"));
        ...
        public App()
        {
            ...
            if (!CheckFileExists("Records.sqlite").Result)
            {
